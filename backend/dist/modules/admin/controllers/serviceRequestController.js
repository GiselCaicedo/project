...
export async function listServiceRequestsCtrl(_req, res) {
    try {
...
export async function updateServiceRequestCtrl(req, res) {
    const { id } = req.params;
    if (!id) {
    ...
    try {
        ...
        const request = await updateServiceRequest(id, status, {
