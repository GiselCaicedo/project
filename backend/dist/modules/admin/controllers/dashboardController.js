import { fetchBillingTotals, fetchClientStatusOverview, fetchDashboardSummary, fetchMonthlyBillingComparison, fetchTopServices, fetchUpcomingInvoiceExpirations, } from '../services/dashboardService.js';
...
export async function getDashboardSummaryCtrl(req, res) {
    try {
        const period = buildPeriod(req.query.from, req.query.to);
...
export async function getBillingTotalsCtrl(req, res) {
    try {
        const period = buildPeriod(req.query.from, req.query.to);
...
export async function getUpcomingExpirationsCtrl(req, res) {
    try {
        const period = (req.query.from || req.query.to)
            ? buildPeriod(req.query.from, req.query.to)
            : null;
...
export async function getClientStatusCtrl(_req, res) {
    try {
...
export async function getTopServicesCtrl(req, res) {
    try {
        const period = buildPeriod(req.query.from, req.query.to);
...
export async function getMonthlyComparisonCtrl(req, res) {
    try {
        const now = new Date();
