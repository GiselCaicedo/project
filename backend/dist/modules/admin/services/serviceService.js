...
const mapServiceRecord = (service) => ({
    ...
    assignments: Array.isArray(service?.client_service) ? service.client_service.map((a) => ({ clientId: a.client_id ?? '', expiry: a.expiry ? (a.expiry instanceof Date ? a.expiry.toISOString() : new Date(a.expiry).toISOString()) : null })) : undefined,
});
