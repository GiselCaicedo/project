...
import { getUsers, getRoles, getPermisos, getUser, updateUser, deleteUser, listRolesRest, getRoleById, createRole, updateRoleCtrl, deleteRoleCtrl, listAllPermissions, listPermissionsGrouped, // ← nuevo
getRolePermissionsCtrl, replaceRolePermissionsCtrl, getGeneralSettingsCtrl, saveGeneralSettingsCtrl, getSmtpConfigCtrl, saveSmtpConfigCtrl, listAlertRulesCtrl, saveAlertRuleCtrl, deleteAlertRuleCtrl, getSecurityPolicyCtrl, saveSecurityPolicyCtrl, getSessionPolicyCtrl, saveSessionPolicyCtrl, getPasswordPolicyCtrl, savePasswordPolicyCtrl, getCompanyProfileCtrl, updateCompanyProfileCtrl, } from '../controllers/configController.js';
