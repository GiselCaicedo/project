...
import { createQuote, QuoteValidationError, QuoteNotFoundError, } from '../../admin/services/quoteService.js';
const toIso = (value) => {
    if (!value)
        return null;
...
export async function listClientQuotes(clientId) {
 ...
 */
export async function fetchClientQuoteById(clientId, quoteId) {
 ...
 */
export async function generateInvoiceFromQuote(quoteId, clientId) {
...
export async function submitClientQuote(clientId, payload) {
    const input = {
        clientId,
...
export async function createComment(clientId, payload) {
...
export async function updateComment(clientId, commentId, payload) {
...
export async function deleteComment(clientId, commentId) {
    const comment = await prisma.quote_comment.findFirst({
        where: {
            id: commentId,
        },
...
export async function listCommentsByQuote(clientId, quoteId) {
    const quote = await prisma.quote.findFirst({
        where: {
            id: quoteId,
            client_id: clientId,
 ...
 * ================================
 */
export async function approveQuote(clientId, quoteId) {
    const quote = await prisma.quote.findFirst({
        where: {
            id: quoteId,
            client_id: clientId,
