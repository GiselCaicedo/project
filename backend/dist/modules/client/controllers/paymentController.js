import { listClientPayments, fetchClientPaymentById, createPayment, listPaymentMethods, listClientInvoicesForPayment, } from '../services/paymentService.js';
...
const buildPayload = async (body, clientId) => {
 ...
 */
export async function listClientPaymentsCtrl(req, res) {
    try {
 ...
 */
export async function getClientPaymentDetailCtrl(req, res) {
    try {
        const { id } = req.params;
        if (!id) {
