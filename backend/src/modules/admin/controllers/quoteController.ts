...
export async function updateQuoteServicesCtrl(req: Request, res: Response) {
  const { id } = req.params
  if (!id) {
    return res.status(400).json({ success: false, message: 'Falta el identificador de la cotización' })
  }
...
export async function createObservationCtrl(req: Request, res: Response) {
  const { id } = req.params
  if (!id) {
    return res.status(400).json({ success: false, message: 'Falta el identificador de la cotización' })
  }
  ...
  try {
    ...
    const payload: CreateObservationInput = {
      quoteId: id,
...
export async function updateObservationCtrl(req: Request, res: Response) {
  ...
  try {
    const payload: UpdateObservationInput = { content: content.trim() }
...
export async function deleteObservationCtrl(req: Request, res: Response) {
  const { observationId } = req.params
  if (!observationId) {
    return res.status(400).json({ success: false, message: 'Falta el identificador de la observación' })
  }
...
export async function listObservationsByQuoteCtrl(req: Request, res: Response) {
  const { id } = req.params
  if (!id) {
    return res.status(400).json({ success: false, message: 'Falta el identificador de la cotización' })
  }
