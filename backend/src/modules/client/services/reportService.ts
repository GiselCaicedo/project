 ...
 */
export async function getInvoicesReport(clientId: string, startDate?: string, endDate?: string) {
  const where: any = {
    client_id: clientId,
    status: true,
  }
  ...
  if (startDate || endDate) {
    where.created = {}
    if (startDate) where.created.gte = new Date(startDate)
    if (endDate) where.created.lte = new Date(endDate)
  }
 ...
 */
export async function getPaymentsReport(clientId: string, startDate?: string, endDate?: string) {
  const where: any = {
    client_id: clientId,
    status: true,
  }
 ...
 */
export async function getServicesStatusReport(clientId: string) {
  const now = new Date()
 ...
 */
export async function getAccountStatement(clientId: string, startDate?: string, endDate?: string) {
  const where: any = {
    client_id: clientId,
    status: true,
  }
