  ...
  return (
    <button
      ...
      className={`flex w-full items-center justify-center gap-2 rounded-md border border-gray-200 px-3
        py-2.5 text-sm font-medium text-gray-700 transition-all
        duration-200 hover:bg-gray-50 hover:text-gray-900 ${!isNavOpen ? 'justify-center p-2' : 'justify-start'} ${className}`}
    >
