          ...
          <div className="space-y-4 md:col-span-3">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              ...
              {selectedService?.supportsApi && (
                <div className="space-y-2 rounded-xl border border-sky-200 bg-sky-50 px-3 py-2 text-xs text-sky-800">
          ...
          <aside className="space-y-3 rounded-2xl border border-gray-200 bg-gray-50 p-4 md:col-span-2">
            ...
            <div className="rounded-xl border border-dashed border-gray-300 p-3 text-xs text-gray-600">
              ...
              <ul className="mt-2 list-inside list-disc space-y-1">
                <li>
                  <code className="rounded bg-white px-1">client_service</code>
                  {' '}
                  almacena las asignaciones.
                </li>
                <li>
                  <code className="rounded bg-white px-1">service_id</code>
                  {' '}
                  referencia al catálogo de servicios.
                </li>
                <li>
                  Los campos
                  <code className="rounded bg-white px-1">frequency</code>
                  {' '}
                  y
                  <code className="rounded bg-white px-1">unit</code>
                  {' '}
                  controlan la recurrencia.
                </li>
              </ul>
            </div>
            <div className="rounded-xl border border-sky-200 bg-white p-3 text-xs text-sky-700">
