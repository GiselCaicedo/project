    ...
    <form onSubmit={handleSubmit} className="flex min-h-full flex-col">
                ...
                {[
                  ...
                  <button
                    ...
                    className={`flex-1 rounded-md px-3 py-2 transition ${
                      type === option.value
                        ? 'bg-white font-medium text-sky-600'
              ...
              {orderedParameters.map(parameter => (
                <div key={parameter.id} className="rounded-lg border border-gray-200 bg-white p-3">
                  ...
                  <input
                    ...
                    className="mt-2 w-full rounded-lg border border-gray-200 px-3 py-2 text-sm text-gray-900 focus:border-sky-500 focus:ring-2 focus:ring-sky-200 focus:outline-none"
                  />
                </div>
              ))}
            </div>
      ...
      <div className="mt-auto space-y-3 border-t border-gray-100 px-5 py-4">
        ...
        <div className="flex justify-end gap-3">
          ...
          <button
            type="submit"
            className="rounded-lg bg-sky-600 px-4 py-2 text-sm font-semibold text-white transition hover:bg-sky-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-sky-500 disabled:cursor-not-allowed disabled:bg-sky-300"
