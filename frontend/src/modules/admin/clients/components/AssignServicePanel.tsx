    ...
    <form onSubmit={handleSubmit} className="flex min-h-full flex-col">
      <div className="grid gap-6 px-5 py-5">
        <div className="space-y-4 md:col-span-3">
          ...
          <div>
            <label className="text-sm font-medium text-gray-700" htmlFor="service-observations">
            ...
            <textarea
              ...
              placeholder="Agrega observaciones o notas sobre este servicio..."
              rows={4}
              className="mt-1 w-full rounded-lg border border-gray-200 px-3 py-2 text-sm text-gray-900 focus:border-primary-500 focus:ring-2 focus:ring-primary-200 focus:outline-none resize-none"
              disabled={submitting}
            />
            <p className="mt-1 text-xs text-gray-500">Estas observaciones serán visibles para el cliente</p>
          </div>
