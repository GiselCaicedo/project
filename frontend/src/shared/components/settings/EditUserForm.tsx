...
import type { BackendUser, Client, Role } from '@shared/services/conexion';
import { useAlerts } from '@shared/components/common/AlertsProvider';
import { getClientsApi, getRolesApi, getUserByIdApi, updateUserApi } from '@shared/services/conexion';
...
export default function EditUserForm({ userId, onCancel, onSuccess }: Props) {
  ...
  if (loading) {
    return <div className="pl-2 text-sm text-gray-600">Cargando...</div>;
  }
  if (err) {
